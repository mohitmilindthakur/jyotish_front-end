...
const Kundali = (props) => (
  ...
  >
    ...
    >
      ...
      {
        p.map(({ sign, planets, house }, index) => {
            ...
            <Fragment key = {house} >
            {
                ...
                (
                    <text className = "planet" x={planet_svg_positions[index][0]} y={planet_svg_positions[index][1]} textAnchor = "middle">
                        ...
                        <tspan className = "planet" x={planet_svg_positions[index][0]}>{planets.slice(0, 3).join(" ")}</tspan>

                        <tspan dy = "5%" className = "planet" x={planet_svg_positions[index][0]} textAnchor = "middle">{planets.slice(2, planets.length).join(" ")}</tspan>
